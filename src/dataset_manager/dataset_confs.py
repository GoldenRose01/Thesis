...
# Dizionari per memorizzare le configurazioni per diversi dataset di log
case_id_col = {}  # Colonna per l'identificatore del caso
activity_col = {}  # Colonna per l'attività
resource_col = {}  # Colonna per la risorsa
timestamp_col = {}  # Colonna per il timestamp completo
label_col = {}  # Colonna per l'etichetta (deviant o regular)
pos_label = {}  # Etichetta positiva (deviant)
neg_label = {}  # Etichetta negativa (regular)
dynamic_cat_cols = {}  # Colonne categoriche dinamiche
static_cat_cols = {}  # Colonne categoriche statiche
dynamic_num_cols = {}  # Colonne numeriche dinamiche
static_num_cols = {}  # Colonne numeriche statiche
filename = {}  # Nome del file per ciascun dataset di log
logs_dir = ""  # Directory dei file di log

# Configurazioni per il dataset "Traffic fines"
for formula in range(1, 3):
    dataset = "traffic_fines_%s" % formula

    # Nome del file per il dataset "Traffic fines"
