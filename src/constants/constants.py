# Importazione del modulo ConstraintChecker dalla directory src.enums
from src.enums.ConstraintChecker import ConstraintChecker

# Importazione delle funzioni di controllo dei vincoli dalla directory src.constraint_checkers
...
# Definizione di un dizionario chiamato CONSTRAINT_CHECKER_FUNCTIONS
# con le chiavi prese dai valori enumerati in ConstraintChecker
# e i valori associati alle funzioni di controllo dei vincoli corrispondenti
