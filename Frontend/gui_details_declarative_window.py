...
class DetailsDeclarativeWindow(QWidget):
    def __init__(self,switch_view_callback):
        super().__init__()
        self.encoding="declarative"
    ...
    def initUI(self):
        ...
        self.title = QLabel(contents_declarative_details["window_title_details"])
        ...
        self.description = QLabel("Impostazioni dettagliate per il declarative encoding")
        ...
        self.back_button = QPushButton(contents_declarative_details["back_button"])
        ...
        self.setWindowTitle(contents_declarative_details["window_title_details"])
